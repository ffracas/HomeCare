...
Node::Node(string t_id, int t_openTimeWindow, int t_closeTimeWindow, 
        ...
        m_arrivalTime (t_openTimeWindow), m_departureTime (t_openTimeWindow), m_isDepot(false) {}
...
Node::Node(Patient t_patient, int t_arrivalTime) 
        ...
        m_service (t_patient.getCurrentService().getService()), m_arrivalTime (t_arrivalTime), m_isDepot(false) {
...
Node::Node(Caregiver t_caregiver) 
        ...
        m_departureTime (t_caregiver.getShiftStartTime()), m_isDepot(true) {}
